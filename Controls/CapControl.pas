...
USES
     ...
     Capacitor, utilities, CapControlVars, CapUserControl, LoadShape;
...
begin
       ...
       Begin
        if not ADiakoptics or (ActorID = 1) then
           ...
           FOR j := 1 to nPhases Do  cBuffer^[j] := ActiveCircuit[ActorID].Solution.VoltInActor1(GetRef(j));
       End;
              ...
              {7-8-10  NormalizeToTOD Algorithm modified to close logic hole between 11 PM and midnight}
                 ...
                 Begin
                  ...
                  Begin
                    ...
                    Begin
                      if PresentState = CTRL_OPEN then PendingChange := CTRL_CLOSE
                      else                             PendingChange := CTRL_OPEN;
                      ShouldSwitch := TRUE;
                    End;
                  End;
                 End;
