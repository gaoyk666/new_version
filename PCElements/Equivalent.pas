...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Function TEquivalent.Edit(ActorID : Integer):Integer;
VAR
...
Begin
  ...
  ActiveCircuit[ActorID].ActiveCktElement := ActiveEquivalentObj;
...
//----------------------------------------------------------------------------
Procedure TEquivalentObj.RecalcElementData(ActorID : Integer);
VAR
   Zs,Zm:Complex;
   i,j:Integer;
   ii,jj:Integer;
...
//----------------------------------------------------------------------------
Procedure TEquivalentObj.CalcYPrim(ActorID : Integer);
...
Begin
 ...
 // Build only YPrim Series
     ...
     If NeedToDoRecalc Then RecalcElementData(ActorID);
...
Function TEquivalentObj.InjCurrents(ActorID : Integer):Integer;
...
//====================================
Procedure TEquivalentObj.GetCurrents(Curr: pComplexArray; ActorID : Integer);
...
//====================================
Procedure TEquivalentObj.GetInjCurrents(Curr:pComplexArray; ActorID : Integer);
...
procedure TEquivalentObj.MakePosSequence(ActorID : Integer);
