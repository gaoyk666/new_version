...
uses
  {$IFNDEF FPC_DLL}ComObj, ActiveX, OpenDSSengine_TLB, StdVcl,{$ENDIF} LineCode;
...
uses {$IFNDEF FPC_DLL}ComServ, {$ENDIF}sysutils, DSSGlobals, LineUnits, ParserDel, Variants, Ucomplex;
