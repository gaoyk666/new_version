...
Function TVCCS.Edit(ActorID : Integer):Integer;
VAR
...
Begin
  ...
  ActiveCircuit[ActorID].ActiveCktElement := ActiveVCCSObj;
  Result := 0;
...
Function TVCCSObj.InjCurrents(ActorID : Integer):Integer;
...
Procedure TVCCSObj.GetCurrents(Curr: pComplexArray; ActorID : Integer);
...
Procedure TVCCSObj.GetInjCurrents(Curr:pComplexArray; ActorID:Integer);
var
  i: Integer;
  i1: complex;
Begin
  if not Closed[1, ActorID] then begin
