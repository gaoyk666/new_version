...
USES
    ...
    ParserDel, DSSClassDefs, DSSGlobals, Circuit, PCElement, Sysutils, MathUtil;
...
begin
     ...
     ELSE PresentState := CTRL_OPEN;
         ...
         CASE ControlType of
              ...
              VOLTAGE:     VoltageLogic; {Reclosing Voltage Relay - definite time}
              REVPOWER:    RevPowerLogic;    // one shot to lockout
              NEGCURRENT:  NegSeq46Logic; // one shot to lockout
              NEGVOLTAGE:  NegSeq47Logic; // one shot to lockout
              GENERIC:   GenericLogic;// one shot to lockout
         End;
end;
